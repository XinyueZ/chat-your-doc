...
| [multi_user_conversation.ipynb](notebooks/multi_user_conversation.ipynb)  | Try to do multi-user chat with LangChain, `ConversationBufferMemory`, `ConversationChain` or LCEL |  | 
