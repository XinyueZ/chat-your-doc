...
- [LangChain/LangGraph: Build Reflection Enabled Agentic](https://medium.com/@teetracker/build-reflection-enabled-agent-9186a35c6581)
👨🏻‍💻 [code](https://github.com/XinyueZ/chat-your-doc/blob/master/advanced/lg_ollama_hands_on_reflection_agent.py)
- [Llama-Index/AgentWorkflow: Build Reflection Enabled Agentic](https://medium.com/@teetracker/llama-index-agentworkflow-build-reflection-enabled-agent-c887f07a8a86)
👨🏻‍💻 [code](https://github.com/XinyueZ/chat-your-doc/blob/master/advanced/li_BI_agent_workflow.py)
- [LangGraph / swarm and supervisor: Build Reflection Enabled Agentic](https://medium.com/@teetracker/langgraph-swarm-and-supervisor-build-reflection-enabled-agentic-flow-6c1af0502c6b)
...
- [CrewAI / Hierarchical Manager: Build Reflection Enabled Agentic](https://medium.com/@teetracker/crewai-hierarchical-manager-build-reflection-enabled-agentic-flow-8255c8c414ec)
